...
const tempConnection = mysql.createConnection({
  host: process.env.DB_HOST || 'backenddb.cluster-c1h3gukzxnqc.us-east-1.rds.amazonaws.com',
  user: process.env.DB_USER || 'admin',
  password: process.env.DB_PASSWORD || 'ibtihel28092003'
});

tempConnection.query(`CREATE DATABASE IF NOT EXISTS ${process.env.DB_NAME || 'backenddb'}`, (err) => {
  if (err) {
